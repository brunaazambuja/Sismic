...
main:
			...
			mov.b 	@r5+, r6				; R6 recebe o tamanho do vetor e o ponteiro de
...
subrot:
			mov.b	@r5+, r7				; R7 recebe o atual menor
			mov 	#1, r4					; Conta a frequência


loop:
			mov.b	@r5+, r8				; R8 recebe o possível novo menor
...
menor:										; Label pra capturar a situação em que vc achou um novo menor
